...
import {
  ...
  Form, Alert, Spinner, ListGroup, ProgressBar
} from "react-bootstrap";
import { FaBook, FaEnvelope, FaUpload, FaUserEdit, FaDownload, FaEye, FaCheckCircle } from "react-icons/fa";
...
const UserDashboard = () => {
  ...
  const {
    ...
    submitAssignment,
    fetchSubmittedAssignments,   // <-- NEW
    submittedAssignments,        // <-- NEW
    activeSection,
    setActiveSection,
  ...
  useEffect(() => {
    ...
    if (activeSection === "assignments" && !submittedAssignments) {
      fetchSubmittedAssignments();
    }
  }, [profileData, registeredPrograms, activeSection]);
        ...
        return (
          <Card className="shadow-sm border-0 hover-card">
            <Card.Body className="p-4">
              ...
              <Card.Title className="h5 fw-bold mb-3">Assignments</Card.Title>

              {/* === SUBMIT NEW ASSIGNMENT === */}
              <div className="border-bottom pb-4 mb-4">
                <h6 className="fw-bold text-primary mb-3">Submit New Assignment</h6>
              ...
              <h6 className="fw-bold text-primary mb-3">Your Submitted Assignments</h6>
              {loading && !submittedAssignments ? (
                ...
                <ListGroup variant="flush">
                  {submittedAssignments.map((assignment) => (
                    <ListGroup.Item 
                      key={assignment.id} 
                      className="d-flex justify-content-between align-items-center p-3 border rounded mb-2 shadow-sm"
                    >
                      <div className="flex-grow-1">
                        ...
                        {assignment.feedback && (
                          <div className="mt-2">
                            <Badge bg="info" className="me-2">Feedback</Badge>
                            <span className="text-muted">{assignment.feedback}</span>
                          </div>
                        )}
                        {assignment.grade && (
                          <div className="mt-1">
                            <Badge bg="primary">Grade: {assignment.grade}/100</Badge>
                          </div>
                        )}
                      </div>
